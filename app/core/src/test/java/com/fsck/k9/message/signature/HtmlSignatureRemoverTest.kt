...
class HtmlSignatureRemoverTest {
    @Test
    fun `old Mail signature format`() {
        val html =
            """This is the body text<br>-- <br>Sent from my Android device with Mail. Please excuse my brevity."""
        ...
        val html =
            ...
            <html>
              ...
              <body bgcolor="#FFFFFF" text="#000000">
                ...
                -- <br>
                <div class="moz-signature">Sent from my Android device with Mail. Please excuse my brevity.</div>
              </body>
            </html>
            """.trimIndent()
    ...
    fun `signature before blockquote tag`() {
        val html =
            ...
            -- <br>
            <blockquote>Sent from my Android device with Mail. Please excuse my brevity.</blockquote>
            </div>
            </body>
            </html>
    ...
    fun `signature after last blockquote tag`() {
        val html =
            ...
            <br>
            -- <br>
            Sent from my Android device with Mail. Please excuse my brevity.
            </body>
            </html>
            """.trimIndent().removeNewlines()
