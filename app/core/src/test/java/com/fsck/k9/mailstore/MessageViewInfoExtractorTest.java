...
public class MessageViewInfoExtractorTest extends K9RobolectricTest {
    public static final String BODY_TEXT = "Mail rocks :>";
    public static final String BODY_TEXT_HTML = "<div dir=\"auto\">Mail rocks :&gt;</div>";
    public static final String BODY_TEXT_FLOWED = "Mail rocks :> \r\nflowed line\r\nnot flowed line";
    ...
    public void testTextPlainFormatFlowed() throws MessagingException {
        ...
        String expectedText = "Mail rocks :> flowed line\r\n" +
                "not flowed line";
        String expectedHtml =
                "<pre class=\"k9mail\">" +
                        "<div dir=\"auto\">" +
                        "Mail rocks :&gt; flowed line<br>not flowed line" +
                        "</div>" +
                        "</pre>";
    ...
    public void testSimpleHtmlMessage() throws MessagingException {
        String bodyText = "<strong>Mail</strong> rocks :&gt;";
