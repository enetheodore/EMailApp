...
@NonNullApi
public class K9ProjectDependency extends DelegatingProjectDependency {

    @Inject
    public K9ProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
